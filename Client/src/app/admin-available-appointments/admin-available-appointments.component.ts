...
@Component({
  selector: 'app-admin-available-appointments',
  templateUrl: './admin-available-appointments.component.html',
  styleUrls: ['./admin-available-appointments.component.css']
})
export class AdminAvailableAppointmentsComponent {
  id: any;
